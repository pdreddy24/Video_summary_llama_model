...
#ask ollama
#client  = ollama.generate(api_key = ollama_api_key)
#response = client.responses.create(model="llama2",
                                  # input="prompt: ")
